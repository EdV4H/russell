...
> [!IMPORTANT] **決定（2026-08-24）: 会議の記録は、決まったことと持ち帰りだけを残す。**
> 議事録・文字起こしは長く、**他人が書いたもの**（`untrusted`）である。丸ごと残すと想起の
> たびに混ざってきて、しかも本人が言っていないことを本人の言葉として思い出す形になりうる。
>
> 残すのは2つだけ:
>
> | 拾うもの | 置き場 |
> |---|---|
> | 決まったこと | 本棚（`shelf.add`。見出し・1〜2文・**出どころ**） |
> | 自分の持ち帰り | 作業（`todo.add`） |
>
> **原文は残さない。** 細部が要るときは出どころから読み直せばよく、そのために出どころを
> 本文へ添える。**確かめられない決定は、決定として使えない。**
>
> 決まっていないものは決定にしない——「検討する」「持ち帰る」「〜の方向で」は決定ではない。
> 自分が動くなら作業、そうでなければ何も残さない。
>
> 要約を残す案（B）と、何も残さない案（C）は採らなかった。要約は「誰も言っていない文」が
> 記憶に固定される点で議事録の原文と同じ危うさがあり、何も残さないと会議に出た意味が
> 次に繋がらない。
